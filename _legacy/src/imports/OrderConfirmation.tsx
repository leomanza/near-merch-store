import svgPaths from "./svg-4tfraa2udz";
...
function Button() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Button">
      <Icon />
      <p className="absolute font-['Red_Hat_Mono:Medium',sans-serif] font-medium leading-[20px] left-[36px] text-[14px] text-neutral-950 text-nowrap top-[8px] tracking-[-0.48px] whitespace-pre">Back to Store</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[69px] items-start left-0 pb-px pl-[75px] pr-[1332.03px] pt-[16px] top-0 w-[1558px]" data-name="Container">
...
function Icon1() {
  return (
    <div className="absolute left-[16px] size-[48px] top-[16px]" data-name="Icon">
...
function Container1() {
  return (
    <div className="bg-green-100 relative rounded-[3.35544e+07px] shrink-0 size-[80px]" data-name="Container">
      <Icon1 />
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-[336.53px] text-[16px] text-center text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] translate-x-[-50%] whitespace-pre">Order Confirmed!</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[56px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[28px] left-[336.25px] text-[#717182] text-[18px] text-center top-0 tracking-[-0.48px] translate-x-[-50%] w-[661px]">Thank you for your purchase. Your order has been received and is being processed.</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[27px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Red_Hat_Mono:Medium',sans-serif] font-medium leading-[27px] left-0 text-[18px] text-neutral-950 text-nowrap top-0 tracking-[-0.48px] whitespace-pre">Order Number</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#717182] text-[16px] text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">NEAR-FZG3CRA-MGQR7O9I</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[59px] items-start relative shrink-0 w-full" data-name="Container">
      <Heading1 />
      <Paragraph1 />
    </div>
  );
...
function Container3() {
  return (
    <div className="bg-[#ececf0] relative rounded-[3.35544e+07px] shrink-0 size-[40px]" data-name="Container">
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">Confirmation Email Sent</p>
    </div>
  );
}

function Text() {
  return <div className="absolute h-[18px] left-[277.2px] top-px w-[23.766px]" data-name="Text" />;
}

function Paragraph2() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] top-0 tracking-[-0.48px] w-[566px]">
        <span>{`We've sent a confirmation email to `}</span>
        <span className="font-['Red_Hat_Mono:SemiBold',sans-serif] font-semibold">davis@demo.everything</span>
        <span className="font-['Red_Hat_Mono:Bold',sans-serif] font-bold"> </span>with your order details and tracking information.
      </p>
      <Text />
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">{`What's Next?`}</p>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p1b43e7f0} id="Vector" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          ...
          <path d={svgPaths.p2eca8c80} id="Vector_3" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M6.25 3.55835L13.75 7.85002" id="Vector_4" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading4() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">Processing Your Order</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] top-0 tracking-[-0.48px] w-[515px]">{`We're preparing your items for shipment. This typically takes 1-2 business days.`}</p>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p33ed6f00} id="Vector" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M12.5 15H7.5" id="Vector_2" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2f5b2980} id="Vector_3" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p76e7200} id="Vector_4" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.pce04cf0} id="Vector_5" stroke="var(--stroke-0, #717182)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Heading5() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[24px] left-0 text-[16px] text-neutral-950 text-nowrap top-[-1px] tracking-[-0.48px] whitespace-pre">{`Shipping & Delivery`}</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#717182] text-[14px] top-0 tracking-[-0.48px] w-[531px]">{`You'll receive tracking information once your order ships. Standard delivery takes 5-7 business days.`}</p>
    </div>
  );
}
...
function OrderConfirmation() {
  return (
    <div className="relative shrink-0 w-[622px]" data-name="OrderConfirmation">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] items-start relative w-[622px]">
        <Container2 />
        <PrimitiveDiv />
        <Container5 />
        <PrimitiveDiv />
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-0 top-0 w-[672px]">
      <Container1 />
      <Heading />
      <Paragraph />
      <Card />
...
function Container14() {
  return (
    <div className="absolute h-[823px] left-[443px] top-[133px] w-[672px]" data-name="Container">
      <Frame />
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="absolute h-[20px] left-[443px] top-[921px] w-[672px]" data-name="Paragraph">
      <p className="absolute font-['Red_Hat_Mono:Regular',sans-serif] font-normal leading-[20px] left-[272.77px] text-[#717182] text-[14px] text-center top-0 tracking-[-0.48px] translate-x-[-50%] w-[325px]">Need help with your order? Contact us at</p>
      <Link />
    </div>
  );
}
...
function OrderConfirmation1() {
  return (
    <div className="bg-white h-[957px] relative shrink-0 w-[1558px]" data-name="OrderConfirmation">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[957px] relative w-[1558px]">
        <Container />
        <Container14 />
        <Paragraph5 />
      </div>
...
export default function OrderConfirmation2() {
  return (
    <div className="bg-white relative size-full" data-name="Order Confirmation">
      <App />
      <Header />
    </div>
  );
